...
(function (DS) {
  ...
  function styleFor(material) {
    if (material === 'cloth') return 'light';
    if (material === 'leaf') return 'grove';
    if (material === 'leather') return 'bear';
    if (material === 'bone') return 'horns';
    if (material === 'iron') return 'plume';
    if (material === 'gold') return 'crown';
    if (material === 'crystal') return 'astral';
    if (material === 'obsidian') return 'void';
    return 'medium';
  }
